...
# OrderBookLevel is 60 bytes (not 16!) due to internal alignment
ENGINE_MMAP = "/dev/shm/beroun/engine_state.bin"
PRICE_SCALE = 1e8

OFF_BEST_BID = 64
OFF_BEST_ASK = 72
OFF_BIDS = 80         # bids[10], each 60 bytes
OFF_ASKS = 680        # asks[10], each 60 bytes
...
OBL_SIZE = 60         # sizeof(OrderBookLevel) — verified from Rust
...
BOOK_DEPTH = 10          # Read all 10 levels for stable depth measurement
